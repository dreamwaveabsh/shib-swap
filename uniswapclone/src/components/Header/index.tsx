...
import Logo from '../../assets/images/shib-logo.png'
    ...
    <HeaderFrame>
      ...
      <HeaderRow>
        ...
        <HeaderLinks>
          ...
          <StyledNavLink id={`swap-nav-link`} to={'#'} isActive={() => history.location.pathname.includes('#')}>
            {t('Chart')}
            <AiOutlineRise />
          </StyledNavLink>
        </HeaderLinks>
          ...
          <AccountElement active={!!account} style={{ pointerEvents: 'auto' }}>
            {account && userEthBalance ? (
              <BalanceText style={{ flexShrink: 0 }} pl="0.75rem" pr="0.5rem" fontWeight={500}>
                {userEthBalance?.toSignificant(4)} wSHIB
              </BalanceText>
            ) : null}
            <Web3Status />
          </AccountElement>
